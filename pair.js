...
const pastebin = new PastebinAPI('CTxOONQZlqkGpEryUasdKrZbC_aJUiRH');
        ...
        try {
            ...
            Pair_Code_By_Malvin_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Malvin_Tech.sendMessage(Pair_Code_By_Malvin_Tech.user.id, { text: 'GODZILA~' + b64data });
...
╔═
╟   『 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 & 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 』  
╟  🎥 𝐘𝐨𝐮𝐓𝐮𝐛𝐞: youtube.com/@nimeshkamihiran  
╟  👑 𝐎𝐰𝐧𝐞𝐫: +94 760771665  
╟  💻 𝐑𝐞𝐩𝐨: github.com/Nimeshkamihiran/GODZILLA-MD  
╟  📢 𝐂𝐡𝐚𝐧𝐧𝐞𝐥: https://whatsapp.com/channel/0029Vb6BQQmFnSz7bmxefu40  
╟  📸 𝐈𝐧𝐬𝐭𝐚: instagram.com/nimeshka.mihiran  
╰  
✦⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅✦  
   𝐄𝐍𝐉𝐎𝐘 𝐆𝐎𝐃𝐙𝐈𝐋𝐋𝐀-𝐌𝐃!  
✦⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅⋆⋅✦  
